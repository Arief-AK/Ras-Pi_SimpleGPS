...
//       SentencePrefix = strtok(CharacterSentence, delimitor);
//       while (SentencePrefix != NULL)
//       {
//           cout << SentencePrefix;
//           cout << "\n";
//           SentencePrefix = strtok(NULL, delimitor);
//       }


//       // Try to compare with RMC
//       SentencePrefix = strtok(CharacterSentence, delimitor);     //Deliminator 1st
//       string strSentencePrefix(SentencePrefix);
//       cout << strSentencePrefix;
//       cout << "\n";

//       result = strSentencePrefix.compare(NMEA_RMCPREFIX);
//       if(result == 0)
//       {
//          comparing = false;
//          cout << "Sucsess";
